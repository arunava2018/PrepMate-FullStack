        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              Access authentic interview experiences from industry professionals
              across leading technology companies. Contribute your insights to
              build a comprehensive knowledge base for the developer community.
            </motion.p>
          ...
          <motion.div
            ...
            <motion.div
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Help fellow developers by sharing detailed insights from your
                interview process, including questions, preparation tips, and
            ...
            <motion.div
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Browse comprehensive interview experiences from various
                companies and roles. Learn from others' journeys to better
                prepare for your own interviews.
              </p>
              <Button
                variant="outline"
