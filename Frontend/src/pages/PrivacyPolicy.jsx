      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            At PrepMate, we value your privacy. This Privacy Policy explains how we
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-10">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2">
              <li>Account details such as your name, email address, and profile data.</li>
              <li>Usage data including pages visited, time spent, and interactions.</li>
              <li>Information you voluntarily share, such as interview experiences or feedback.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-2 mt-2">
              ...
              <li>Personalize your learning experience and progress tracking.</li>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              trusted third-party service providers (e.g., hosting, analytics, email
              services) strictly to support our platform’s operations.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              measures. While we strive to protect your information, no method of
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Depending on your region, you may have rights to access, update, or delete
              your personal data. To exercise these rights, please{" "}
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              PrepMate uses cookies to improve user experience, analyze traffic, and
              personalize content. For more details, please review our{" "}
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              We may update this Privacy Policy periodically. Updates will be posted on
